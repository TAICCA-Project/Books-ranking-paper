...
| **博客來排行榜** | `ranking_30pbooks_daily_update.ipynb` | 📓 排行榜初步爬蟲<br>✅ 每日更新功能<br>✅ Top 30+ 書籍<br>✅ 資料探索分析 |

> 💡 **提示**：Jupyter Notebook 檔案是重要的初步爬蟲實作，適合用於快速測試、資料探索和原型開發。建議先執行 Notebook 版本熟悉爬取流程，再使用 Python 腳本進行大規模資料收集。
...
│   ├── ranking_30pbooks_daily_update.ipynb  # ⭐ 博客來排行榜初步爬蟲（Notebook）
